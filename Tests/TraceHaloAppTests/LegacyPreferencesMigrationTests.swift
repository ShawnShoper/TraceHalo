...
final class LegacyPreferencesMigrationTests: XCTestCase {
    func testMigrationCompletionKeyRemainsCompatibleWithOlderBuilds() {
        XCTAssertEqual(
            LegacyPreferencesMigration.completionKey,
            TraceHaloLegacyIdentifiers.preferencesMigrationCompletionKey
        )
    }
