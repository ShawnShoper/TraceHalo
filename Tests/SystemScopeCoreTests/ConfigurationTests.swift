...
final class ConfigurationTests: XCTestCase {
    ...
    func testStandardConfigurationHasExpectedQuickItems() {
        ...
        XCTAssertEqual(
            items.map(\.action),
            [.systemScope, .activityMonitor, .console, .terminal, .systemInformation, .systemSettings]
        )
        XCTAssertEqual(
    ...
    func testQuickActionRawValuesStayStableForPersistedPreferences() {
        XCTAssertEqual(
    ...
    func testLegacySystemScopeQuickItemTitleMigratesToTraceHalo() throws {
